    ...
    <table width="96%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#DFEFFF"
        ...
        <tr>
            <td style="padding-left: 8px;" class="style1">
                <span style="font-size: 9pt">起始时间</span>
                <input type="text" id="beginTime" onfocus="calendar()" runat="server" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: 9pt">结束时间</span>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button_Del" runat="server" Text=" 删 除 " OnClick="ButtonDel_Click" />
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" Width="100%" DataKeyNames="ID" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="接收内容" DataField="ReceiveMsg" />
                        <asp:BoundField HeaderText="接收时间" DataField="ReceiveTime" />
                        <%--<asp:BoundField HeaderText="是否处理" DataField="IsResult" />--%>
                        <asp:BoundField HeaderText="结果说明" DataField="IsResultDes" />
                        <asp:HyperLinkField HeaderText="详细信息" Text="查看" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="receivemsg_Info.aspx?ID={0}">
