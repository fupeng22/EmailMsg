    ...
    <table width="96%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#DFEFFF"
        ...
        <tr>
            <td height="32" style="padding-left: 8px;">
                <asp:Button ID="Button1" runat="server" Text="添加部门" OnClick="Button1_Click" Height="29px" />&nbsp;
                <asp:Button ID="Button2" runat="server" Text="删除部门" OnClick="Button2_Click" Height="29px" />&nbsp;
                <asp:Button ID="Button4" runat="server" Text="添加根节点" OnClick="Button4_Click" Height="30px" />&nbsp;
                <asp:Button ID="Button3" runat="server" Text="修改部门" OnClick="Button3_Click" Height="30px" />&nbsp;
            </td>
        </tr>
    </table>
