...
<body>
    <form id="form1" runat="server">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">用户信息列表</td>
				</tr>
			</table>
<table width="96%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#DFEFFF" bordercolorlight="#77AEEE">
	...
	<td height="32" style="padding-left:8px;">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:LinkButton ID="LinkButton1" runat="server" Font-Size="10pt" OnClick="LinkButton1_Click">添加新用户</asp:LinkButton></span></td>
					...
					<asp:GridView ID="GridView1" runat="server" Width="100%"  
                            ...
                            <Columns>
                              <asp:BoundField DataField="ID" HeaderText="ID编号" ></asp:BoundField>
                                ...
                                <asp:BoundField HeaderText="最近登录时间" DataField="LoginTime" />
                                <asp:TemplateField HeaderText="编辑">
                                <ItemTemplate>
										<a href='del_user.aspx?Action=DelUser&UserID=<%#Eval("ID")%>' onclick="javascript:if(confirm('您确定要删除吗？')){return true;}else{return false;}">删除</a>
								</ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
