...
<body>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">人员的资料</td>
				</tr>
			</table>
...
<tr>
    ...
    <td bgcolor="#ffffff">
        <asp:Label ID="ShowWorkerID" runat="server"></asp:Label></td>
  </tr>
   
  <tr>
    <th style="height:30px;background-color:#dfefff;" align="right">人员姓名：</th>
    <td bgcolor="#ffffff"><asp:TextBox ID="WorkerName" runat="server" Columns="35" MaxLength="20"></asp:TextBox>
  ...
  <tr>
    ...
    <td bgcolor="#ffffff"><asp:DropDownList id="ddlGroupName" runat="server" 
  ...
  <tr>
    ...
    <td bgcolor="#ffffff"><asp:TextBox ID="Email" runat="server" Columns="35" MaxLength="50"></asp:TextBox>
        ...
        <br /><asp:RegularExpressionValidator ID="RegularExpressionValidator3" 
            ...
            Display="Dynamic" ErrorMessage="E-mail地址格式不正确" 
            ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
            ForeColor="Red"></asp:RegularExpressionValidator></td>
  </tr>
  <tr>
    <th style="height:30px;background-color:#dfefff;" align="right">性别：</th>
    <td bgcolor="#ffffff">
