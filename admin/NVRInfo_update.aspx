<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NVRInfo_update.aspx.cs" Inherits="admin_NVRInfo_update" %>
    ...
    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30" class="title_top" align="center">
                添加NVR设备<input type="hidden" id="hid_NVRInfoId" runat="server" />
            </td>
        </tr>
    </table>
