...
<body>
    ...
    <br />
    <span style="padding: 7px"><span style="font-size: medium">故障编号:</span><asp:Label
        runat="server" ID="lblAlarmTypeId" ForeColor="Blue" Font-Bold="true" Font-Size="Medium"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span style="font-size: medium">故障类型:</span><asp:Label runat="server" ID="lblAlarmTypeName"
    ...
    <asp:Repeater ID="rpt_ExampleGraph" runat="server">
        <ItemTemplate>
            <a target="_blank" href='exampleGraphView.aspx?exampleGraphPath=<%#Eval("graphPath")%>'>
                <img src='<%#Eval("graphPath")%>' style="width: 350px; height: 200px" alt="示意图" title="点击可查看原始示意图"/></a>
        </ItemTemplate>
    </asp:Repeater>
    </form>
</body>
