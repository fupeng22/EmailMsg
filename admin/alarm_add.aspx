<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alarm_add.aspx.cs" Inherits="admin_alarm_add" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>报警类型添加界面</title>
...
<body>
    ...
    <table cellspacing="1" cellpadding="3" width="96%" align="center" bgcolor="#77aeee"
        ...
        <tr>
            ...
            <td bgcolor="#ffffff">
                <asp:TextBox ID="ID" runat="server" Columns="35" MaxLength="60"></asp:TextBox>
                <span class="style2">&nbsp;&nbsp;*必填项</span>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ID"
                    Display="Dynamic" ErrorMessage="请输入报警类型ID编号" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <th style="height: 30px; background-color: #dfefff;" align="right">
            ...
            <td bgcolor="#ffffff">
                <asp:TextBox ID="AlarmTypeName" runat="server" Columns="35" MaxLength="60"></asp:TextBox>
                <span class="style2">&nbsp;&nbsp;*必填项</span>
                <br />
